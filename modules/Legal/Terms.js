...
This privacy policy has been compiled to better serve those who are concerned with how their 'Personally Identifiable Information' (PII) is being used online. PII, as described in US privacy law and information security, is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context. Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your Personally Identifiable Information in accordance with our website.
      ...
      <h3 style={{ textAlign: 'center', fontSize: 13, fontWeight: 'bold', padding: 3 }}>
      ...
      <h3 style={{ textAlign: 'center', fontSize: 13, fontWeight: 'bold' }}>
      ...
      <ol style={{ padding: 2, textAlign: 'center', fontSize: 12 }}>
        <li style={{ textAlign: 'center', fontSize: 11, padding: 5, margin: 2 }}>
        ...
        <li style={{ textAlign: 'center', fontSize: 11, padding: 5 }}>
      ...
      <h3 style={{ textAlign: 'center', fontSize: 13, fontWeight: 'bold', marginTop: 10 }}>
      ...
      <p style={{ textAlign: 'center', fontSize: 12 }}>
        {`You can choose to have your computer warn you each time a cookie is being sent,
          ...
          It won't affect the user's experience that make your site experience more efficient
      ...
      <p style={{ textAlign: 'center', fontSize: 12 }}>
        ...
        {`We use Google AdSense Advertising on our website.
         ...
         to our site and other sites on the Internet.
    ...
    <div className="conditions">
      ...
      <p style={{ textAlign: 'center' }}> This too. </p>
    </div>
  </div>
);
