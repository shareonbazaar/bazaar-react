        ...
        <div className={`page-wrapper ${this.state.openSideBar ? 'menu-visible' : ''}`}>
          ...
          <section className="one wrapper style1 special">
            <div className="inner">
              <header className="major">
                ...
                {/* eslint-enable */}
              </header><img alt="" width="75%" src="images/skills.png" />
            </div>
          </section>
          <section className="two wrapper alt style2 special" style={{ padding: '40px 0px' }}>
            <div className="inner">
              <header className="major">
                ...
                {/* eslint-enable */}
              </header><img alt="" width="75%" src="images/network.png" />
            </div>
          </section>
          <section className="three wrapper style3">
            <div className="inner">
              ...
              </ol><img alt="" style={{ display: 'block', margin: '0 auto', width: '75%' }} src="images/timebanking.png" />
            </div>
          </section>
          ...
          <footer className="footer">
            <h3>Our Team</h3>
            <div className="team">
              <div className="person"><img alt="" src="/images/nina.png" />
                <p>Nina</p>
              </div>
              <div className="person"><img alt="" src="/images/thorben.png" />
                <p>Thorben</p>
              </div>
              <div className="person"><img alt="" src="/images/omer.png" />
                <p>Ömer</p>
              </div>
              <div className="person"><img alt="" src="/images/rory.png" />
                <p>Rory</p>
              </div>
            </div>
            <ul className="icons">
